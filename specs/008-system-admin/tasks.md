...
- [X] T045 [US3] 測試操作日誌列表查詢（分頁、排序）
- [X] T046 [US3] 測試操作類型篩選（綠建/藍改/紅刪/橙庫存/黃留言）
- [X] T047 [US3] 測試日期範圍篩選
- [X] T048 [US3] 測試操作者搜尋（後端已實作，前端 UI 可選）
- [X] T049 [US3] 驗證刪除操作者後日誌仍保留暱稱快照
- [X] T050 [US3] 驗證 JSONB 查詢正確運作（如「庫存從 100 調整」）
