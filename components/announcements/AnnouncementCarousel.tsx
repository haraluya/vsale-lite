...
export function AnnouncementCarousel({ announcements }: AnnouncementCarouselProps) {
  ...
  return (
    <div className="relative aspect-[10/3] w-full max-w-full overflow-hidden rounded-none border-2 md:border-3 border-black bg-gray-100 shadow-neo-sm md:shadow-neo">
      {/* 廣告圖片 */}
      {current.series_id ? (
