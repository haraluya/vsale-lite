-- ============================================================================
-- Migration: 修復組合優惠快照欄位名稱錯誤
-- Date: 2026-01-30
--
-- 問題：
-- - order_combo_deal_items 表的欄位名稱是 combo_deal_snapshot
-- - 但函式中使用了錯誤的欄位名稱 snapshot
-- - 導致訂單轉為「出貨中」時出現 column "snapshot" does not exist 錯誤
--
-- 修復內容：
-- 1. mark_order_as_shipping：將 snapshot 改為 combo_deal_snapshot
-- 2. cancel_order_and_restore_stock：將 snapshot 改為 combo_deal_snapshot
-- ============================================================================
